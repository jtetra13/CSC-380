...
class GuiQuery(Resource):
    ...
    def delete(self):
        ...
        if parse_res['list_type'] == 2:
            return self.ignore_list_delete( parse_res)
        elif parse_res['list_type'] == 1:
    ...
    def put(self):
        ...
        if parse_result['list_type'] == 2:
            resp =self.watch_list_put(parse_result)
        elif parse_result['list_type'] == 1:
            resp =self.ignore_list_put(parse_result)
        else:
            return custom_error(400, "need type for list", "no_action")
